...
func (s *TeamService) IsTeamActiveById(id int) bool {
	count, _ := s.teamRepo.CountActiveById(id)
	return count > 0
}
...
func (s *TeamService) GetAllTopTeamUSSD(page int) ([]*entity.Team, error) {
	return s.teamRepo.GetAllTopTeamUSSD(page)
}
